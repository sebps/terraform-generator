...
var rootCmd = &cobra.Command{
	...
	Short: "CLI tool to generate terraform components",
	Long: `
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.terraform-generator.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".terraform-generator" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".terraform-generator")
	}
